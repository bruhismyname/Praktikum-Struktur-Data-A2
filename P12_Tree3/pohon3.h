...
/*function linearBFS(P:bintree3, N:integer) -> list1
Mengembalikan sebuah list (tipe List1) yang berisi elemen-elemen dari pohon biner P pada level/generasi N.}
membantu membua linearBreadthFS */
